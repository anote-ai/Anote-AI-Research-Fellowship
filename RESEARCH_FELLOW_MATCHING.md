# Anote Research Paper — Fellow Matching

**Summer 2026 | Anote AI Research Fellowship**

Each fellow is assigned to (or selects) one research paper topic. The goal is to produce a complete, publishable paper by the end of the summer — submitted to arXiv and at least one journal or conference.

> **Repo:** [github.com/anote-ai/Research](https://github.com/anote-ai/Research)
> **Master tracker:** `anote_fellowship_tracker.xlsx` in the repo root.
> Fellows may also propose their own topic — bring it to the Tuesday AI Research Standup for approval.

---

## Active Tracks — Summer 2026 Priority Papers
...
## Backlog Tracks — Available for Fellow Selection
...
## Fellow Paper Deliverable Checklist

Every fellow must complete the following by **August 10, 2026**:

- [ ] Topic confirmed with Natan (by June 9 standup)
- [ ] Literature review complete
- [ ] Abstract and outline drafted (by June 23 standup)
- [ ] Methodology and experiments section written (by July 14 standup)
- [ ] Full draft shared with team for feedback (by July 21 standup)
- [ ] Revisions incorporated (by July 28 standup)
- [ ] Paper submitted to arXiv
- [ ] Paper submitted to at least one journal or conference
- [ ] Paper presented at Final Presentations (August 5)

---

## Research Standup Cadence

| Day | Time (EST) | Event |
|-----|-----------|-------|
| Every Tuesday | 5:00 PM – 5:30 PM | AI Research Standup (progress check, blockers, peer feedback) |
